...
export default function NeedSelector({ language }: NeedSelectorProps) {
  ...
  const needs = [
    {
      ...
      title:
        language === "en"
          ...
          : language === "hi"
            ? "व्यवसाय और उद्यमिता"
            : "व्यावसाय आणि उद्यमिता",
      description:
        language === "en"
          ? "Start or expand a business"
          : language === "hi"
            ? "एक व्यवसाय शुरू या विस्तार करें"
            : "व्यावसाय सुरू किंवा विस्तृत करा",
    },
    {
      id: "education",
      icon: GraduationCap,
      title:
        language === "en"
          ...
          : language === "hi"
            ...
            : "शिक्षा आणि कौशल विकास",
      description:
        language === "en"
          ? "Pursue higher education or skill training"
          : language === "hi"
            ? "उच्च शिक्षा या कौशल प्रशिक्षण प्राप्त करें"
            : "उच्च शिक्षा किंवा कौशल प्रशिक्षण प्राप्त करा",
    },
    {
      id: "other",
      icon: HelpCircle,
  ...
  const handleSelectNeed = (needId: string) => {
    ...
    setTimeout(() => {
      navigate("/onboarding/requirement");
    }, 300);
  };
      ...
      >
        ...
        <motion.div className="text-center mb-12" variants={itemVariants}>
          ...
          <p className="text-neutral-600">
            Choose the area that best fits your requirement
          </p>
        </motion.div>
